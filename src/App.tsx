  ...
  return(
    <>
      ...
      <div>
        ...
        <p className='texto'>Amor, eu quero que você saiba que eu sou muito orgulhoso de ser o seu namorado e futuro marido, sinto muito orgulho da pessoa que você é e de tudo que você conquistou e vai conquistar.</p>
        ...
        <p className='texto'>Eu te amo com todo o meu coração.</p>
